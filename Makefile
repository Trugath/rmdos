...
# Lean product floppy: COMMAND + AUTOEXEC + BIN tools + DEMO/STAR.
OS_IMAGE_DEPS := $(BOOT_BIN) $(KERNEL_BIN) \
...
define PACK_TEST_HARNESS_FILES
...
$(TEST_IMAGE): $(TEST_IMAGE_DEPS)
	$(call PACK_TEST_IMAGE,$@,$(EMPTY_AUTOEXEC))

$(COMPAT_IMAGE): $(TEST_IMAGE_DEPS) $(COMPAT_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(COMPAT_AUTOEXEC))

$(PING_IMAGE): $(TEST_IMAGE_DEPS) $(PING_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(PING_AUTOEXEC))

$(DHCP_IMAGE): $(TEST_IMAGE_DEPS) $(DHCP_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(DHCP_AUTOEXEC))

$(TELNET_IMAGE): $(TEST_IMAGE_DEPS) $(TELNET_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(TELNET_AUTOEXEC))
...
$(FORMAT_HD_IMAGE): $(TEST_IMAGE_DEPS) $(FORMAT_HD_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(FORMAT_HD_AUTOEXEC))

$(FAT16_HD_IMAGE): $(TEST_IMAGE_DEPS) $(FAT16_HD_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(FAT16_HD_AUTOEXEC))

$(PARTEDIT_HD_IMAGE): $(TEST_IMAGE_DEPS) $(PARTEDIT_HD_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(PARTEDIT_HD_AUTOEXEC))

$(MULTILET_HD_IMAGE): $(TEST_IMAGE_DEPS) $(MULTILET_HD_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(MULTILET_HD_AUTOEXEC))

$(EXTPART_HD_IMAGE): $(TEST_IMAGE_DEPS) $(EXTPART_HD_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(EXTPART_HD_AUTOEXEC))

$(SUBST_IMAGE): $(TEST_IMAGE_DEPS) $(SUBST_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(SUBST_AUTOEXEC))

$(BATCH_IMAGE): $(TEST_IMAGE_DEPS) $(BATCH_AUTOEXEC) $(CALLTST_BAT) $(CALLTST2_BAT)
	$(PYTHON) -m scripts.mkfs_fat12 --output $@ --boot $(BOOT_BIN) --kernel $(KERNEL_BIN) \
		$(PACK_OS_IMAGE_FILES) \
		$(PACK_TEST_HARNESS_FILES) \
...
$(DISK_IMAGE): $(TEST_IMAGE_DEPS) $(DISK_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(DISK_AUTOEXEC))

$(INSTALL_IMAGE): $(TEST_IMAGE_DEPS) $(INSTALL_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(INSTALL_AUTOEXEC))

$(NET_IMAGE): $(TEST_IMAGE_DEPS) $(NETTEST_COM) $(NET_AUTOEXEC) $(NET_CONFIG)
	$(call PACK_TEST_IMAGE_CFG,$@,$(NET_AUTOEXEC),$(NET_CONFIG))

$(GZIP_IMAGE): $(TEST_IMAGE_DEPS) $(GZIP_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(GZIP_AUTOEXEC))

$(UTILS_IMAGE): $(TEST_IMAGE_DEPS) $(UTILS_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(UTILS_AUTOEXEC))

$(DISKCOPY_IMAGE): $(TEST_IMAGE_DEPS) $(DISKCOPY_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(DISKCOPY_AUTOEXEC))

$(DISKCOMP_IMAGE): $(TEST_IMAGE_DEPS) $(DISKCOMP_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(DISKCOMP_AUTOEXEC))

$(ANSI_IMAGE): $(TEST_IMAGE_DEPS) $(ANSI_AUTOEXEC) $(ANSI_CONFIG)
	$(call PACK_TEST_IMAGE_CFG,$@,$(ANSI_AUTOEXEC),$(ANSI_CONFIG))

$(EMS_IMAGE): $(TEST_IMAGE_DEPS) $(EMS_AUTOEXEC) $(EMS_CONFIG)
	$(call PACK_TEST_IMAGE_CFG,$@,$(EMS_AUTOEXEC),$(EMS_CONFIG))

$(STUBCFG_IMAGE): $(TEST_IMAGE_DEPS) $(NETTEST_COM) $(STUBCFG_AUTOEXEC) $(STUBCFG_CONFIG)
	$(call PACK_TEST_IMAGE_CFG,$@,$(STUBCFG_AUTOEXEC),$(STUBCFG_CONFIG))

$(MOUSE_IMAGE): $(TEST_IMAGE_DEPS) $(MOUSE_AUTOEXEC)
	$(call PACK_TEST_IMAGE,$@,$(MOUSE_AUTOEXEC))
...
test: all bios-tests $(TEST_IMAGE) $(COMPAT_IMAGE) $(PING_IMAGE) $(DHCP_IMAGE) $(TELNET_IMAGE) $(NET_IMAGE) $(STAR_IMAGE) $(BIGEXE_IMAGE) $(DIR_IMAGE) $(FORMAT_IMAGE) $(FORMAT_HD_IMAGE) $(FAT16_HD_IMAGE) $(PARTEDIT_HD_IMAGE) $(MULTILET_HD_IMAGE) $(EXTPART_HD_IMAGE) $(SUBST_IMAGE) $(BATCH_IMAGE) $(DISK_IMAGE) $(GZIP_IMAGE) $(UTILS_IMAGE) $(DISKCOPY_IMAGE) $(DISKCOMP_IMAGE) $(ANSI_IMAGE) $(EMS_IMAGE) $(STUBCFG_IMAGE) $(MOUSE_IMAGE) $(INSTALL_IMAGE)
	...
	$(PYTHON) -m tests.test_test_img_layout
	$(PYTHON) -m tests.test_bpb_mount_e2e
