"""E2E: BIN\\MOUSE + DEMO\\MOUSETST via inject port 0x8903 → MOUSE OK."""
...
SERIAL = BUILD / "serial-mouse.log"
IMAGE = BUILD / "os-mouse.img"
MARKER = "MOUSE OK"


def test_mouse_on_image() -> None:
    raw = IMAGE.read_bytes()
    assert fat12.find_directory_entry(raw, "BIN\\MOUSE.COM").size_bytes > 0
    assert fat12.find_directory_entry(raw, "DEMO\\MOUSETST.COM").size_bytes > 0


def test_mouse_e2e() -> None:
    env = os.environ.copy()
