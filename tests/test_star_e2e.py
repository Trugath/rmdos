"""E2E: STAR.COM CGA starfield reaches STAR:start marker."""
...
IMAGE = BUILD / "os-star.img"
MARKER = "STAR:start"


def test_star_on_image() -> None:
    raw = IMAGE.read_bytes()
    ent = fat12.find_directory_entry(raw, "DEMO\\STAR.COM")
    assert ent.size_bytes > 0
    ae = fat12.find_directory_entry(raw, "AUTOEXEC.BAT")
    assert ae.size_bytes >= 4


def test_star_e2e() -> None:
    env = os.environ.copy()
